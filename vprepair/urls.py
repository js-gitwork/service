...
urlpatterns = [
    ...
    path('reports/<int:report_id>/assign/', views.assign_task, name='assign_task'),  # Opdateret til assign_task
    ...
    path('assign_task/<int:report_id>/', views.assign_task, name='assign_task'),
    path('take_over_task/<int:report_id>/', views.take_over_task, name='take_over_task'),
    path('start_task/<int:report_id>/', views.start_task, name='start_task'),
]
